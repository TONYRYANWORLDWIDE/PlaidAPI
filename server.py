...
PLAID_CLIENT_ID = '5dd1f3dc21746b001202a107'
PLAID_SECRET = '3277b227abe1d17cc7ecb4d86d6701'
PLAID_PUBLIC_KEY = '4c7c125290f570399411842e0b83ab'
...
def get_access_token():
  ...
  print('public token from form:' + public_token )
  try:
...
def get_balance():
  ...
  # r = jsonify({'error': None, 'balance': balance_response})
  # print('r:' + r)
  # return jsonify({'error': None, 'balance': balance_response})
  r = jsonify({'error': None, 'balance': balance_response})  
  accounts = balance_response['accounts']
  for x in accounts:
    if x['account_id'] == 'qbyekK7YBzseLzykLknjIawypJQEZRuJgqOKd':
        print("Available Balance:" + x['balances']['available'])
  return jsonify({'error': None, 'balance': balance_response})
